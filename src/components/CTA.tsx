            ...
            <div className="grid lg:grid-cols-2 gap-10 lg:gap-16 items-center">
              ...
              >
                ...
                <a
                  ...
                  onClick={() => { if (window.gtag) { window.gtag('event', 'conversion', { send_to: 'AW-9133469546/eg_tjb41BA0k6pZQ6-ya4g' }); window.gtag('event', 'conversion', { send_to: 'AW-18065137326/JT-gCKO875kcEK69kKZD', value: 10.0, currency: 'INR' }); } }}
